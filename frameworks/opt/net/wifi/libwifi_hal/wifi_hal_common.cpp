...
#define BCM_WIFI6_DRIVER_MODULE_PATH     WIFI_MODULE_PATH"bcmdhd_wifi6.ko"
#define BCM_AW_DRIVER_MODULE_PATH	 WIFI_MODULE_PATH"cywdhd.ko"
...
#define BCM_AW_DRIVER_MODULE_NAME	 "cywdhd"
#define BCM_DRIVER_MODULE_NAME      	 "bcmdhd"
#define BCM_WIFI6_DRIVER_MODULE_NAME     "bcmdhd_wifi6"
...
wifi_ko_file_name module_list[] =
{
	...
	{"AP6275S",   BCM_WIFI6_DRIVER_MODULE_NAME, BCM_WIFI6_DRIVER_MODULE_PATH, UNKKOWN_DRIVER_MODULE_ARG},
	{"APXXX",           BCM_DRIVER_MODULE_NAME,       BCM_DRIVER_MODULE_PATH, UNKKOWN_DRIVER_MODULE_ARG},
	{"CM256",        BCM_AW_DRIVER_MODULE_NAME,    BCM_AW_DRIVER_MODULE_PATH, UNKKOWN_DRIVER_MODULE_ARG},
...
int wifi_change_fw_path(const char *fwpath) {
  ...
  if (fd < 0) {
    fd = TEMP_FAILURE_RETRY(open(WIFI6_DRIVER_FW_PATH_PARAM, O_WRONLY));
    if (fd < 0) {
